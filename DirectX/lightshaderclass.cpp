...
bool LightShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	//error = wcscpy_s(vsFilename, 128, L"../DirectX/light.vs");
	error = wcscpy_s(vsFilename, 128, L"../DirectX/point_lights.vs");
	if (error != 0)
	{
		return false;
	}
	...
	//error = wcscpy_s(psFilename, 128, L"../DirectX/light.ps");
	error = wcscpy_s(psFilename, 128, L"../DirectX/point_lights.ps");
	if (error != 0)
	{
		return false;
	}
